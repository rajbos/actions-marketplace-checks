...
- **[Enable Dependabot](.github/workflows/dependabot-updates.yml)**: Automatically enables Dependabot on forked repositories to detect security vulnerabilities
- **[Update Forks](.github/workflows/update-forks.yml)**: Automatically syncs all forked repositories with their upstream sources (runs daily at 2 AM UTC)
